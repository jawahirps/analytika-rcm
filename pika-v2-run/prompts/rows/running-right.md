Create one horizontal animation strip for Codex pet `pika`, state `running-right`.
...
Identity: same pet in every frame: Preserve the existing 8-bit pixel Pika: compact yellow electric mouse, red cheek marks, black-tipped ears, lightning-bolt tail, black pixel outlines, transparent background. Upgrade only with coherent looking directions.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
